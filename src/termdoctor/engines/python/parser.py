...
ERROR_LINE_PATTERN = re.compile(
    ...
    r"|KeyboardInterrupt|SystemExit|GeneratorExit|StopIteration|StopAsyncIteration|MemoryError"
    r"|ExceptionGroup|BaseExceptionGroup"
    r"|ImproperlyConfigured|NoReverseMatch|TemplateDoesNotExist|ObjectDoesNotExist|DoesNotExist"
    r"|MultipleObjectsReturned|FixtureLookupError|Failed|Skipped"
    r"|NoResultFound|MultipleResultsFound|BadRequest|BadParameter|ClickException"
